...
export function InsbyreKeychain() {
  return (
...
function Keychain({ maxSpeed = 50, minSpeed = 10 }) {
  const band = useRef(),
    fixed = useRef(),
    j1 = useRef(),
    j2 = useRef(),
  ...
  const texture = useTexture('/textures/rope.jpg');
...
function FlowerModel(props) {
  const { nodes, materials } = useGLTF('/models/insbyre-flower.glb');
  return (
